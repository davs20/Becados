        ...
        <div class="container-fluid"  style="margin: 40px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido al listado de alumnos, aqui podras ver el en detalle cada alumno que ha alcanzado la meta &nbsp; <i class="zmdi zmdi-search"></i>
                </div>
            </div>
            <div class="table-responsive">
              ...
              $sql="SELECT *,carreras.Nombre_Carrera FROM estudiantes  INNER JOIN carreras ON carreras.ID_Carrera=estudiantes.ID_Carrera where estudiantes.Meta=1";
