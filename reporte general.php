...
<tr>
                    ...
                    <th style="width: 15%;">'.$tabla['ID_Usuario'].'</th>
                    <th style="width: 30%;">'.$tabla['Nombre_Completo'].'</th>
                    <th style="width: 26%;">'.$tabla['Nombre_Carrera'].'</th>
                    <th style="width: 25%; text-center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$tabla['Horas_Cumplidas'].'</th>
