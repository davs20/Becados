...
if($_SESSION['UserPrivilege']=='Estudiante'){
  ...
  $fields="Nombre_Completo='$nombre',Numero_Telefono='$tel',Correo_Electronico='$email',ID_Usuario='$user'";
}
        if(consultasSQL::UpdateSQL("estudiantes", $fields, "ID_Usuario='".$olduser."'")){
