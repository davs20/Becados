    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Becados UNICAH SI<small>     Administración > Editar Horas</small></h1>
            </div>
        </div>
        <div class="conteiner-fluid">
          <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">

            <li role="presentation"><a href="adminlistteacher - copia.php">Ingresar Horas</a></li>
            <li role="presentation"  class="active"><a href="adminpersonal.php">Editar Horas</a></li>
          </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido, en esta sección podra EDITAR las horas de un estudiante, en caso de haberse equivocado en el ingreso de las mismas.
                </div>
            </div>
        </div>
