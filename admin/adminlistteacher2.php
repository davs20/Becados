...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
          <form class="busqueda" style="width: 30% !important;" action="adminlistteacher2.php" method="get" autocomplete="off">
            ...
            <h2 class="text-center all-tittles" style="clear: both; ">Listado de Estudiantes</h2>
                                ...
                                <div class="table-responsive table-hover text-center">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 15%;"><a href="adminlistteacher3.php?idedit='.$dataT['ID_Usuario'].'">'.$dataT['Nombre_Completo'].'</div></a>
                                            <div class="div-table-cell" style="width: 15%;">'.$dataT['Correo_Electronico'].'</div>
                                            <div class="div-table-cell" style="width: 15%;">'.$dataT['Numero_De_Telefono'].'</div>
                                        </div>
                                    </div>
                                </div>
                            </li>';
